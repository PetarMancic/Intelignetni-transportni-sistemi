...
{
    public class BookVehicleCommandHandler : IRequestHandler<BookVehicleCommand, int>
    {
        ...
        public async Task<int> Handle(BookVehicleCommand request, CancellationToken cancellationToken)
        {
            ...
            if (ride == null)
                throw new Exception("Failed to book ride");
